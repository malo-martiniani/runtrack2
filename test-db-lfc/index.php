...
try {
    ...
    $pdo = new PDO("mysql:host=localhost;dbname=lfc", "root", "");
    ...
    echo "<table border='1'>";
    echo "<tr><th>ID</th><th>Name</th><th>Surname</th><th>Nationality</th><th>Age</th><th>Number</th><th>Value</th><th>Goals</th><th>Assists</th></tr>";
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo "<td>" . htmlspecialchars($row['transfer_value']) . "</td>";
